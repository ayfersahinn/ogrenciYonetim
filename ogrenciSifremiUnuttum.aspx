<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ogrenciSifremiUnuttum.aspx.cs" Inherits="ogrenciYonetim.ogrenciSifremiUnuttum" %>
...
<body>
    <form id="form2" runat="server" defaultbutton="Button1">
        <div style="width:700px; margin:auto;" class="text-center" >
            <br />
            <h2 class="text-center text-bold" style="color:#286090; font-weight:bolder">Öğrenci Şifre Yenileme </h2>
            ...
            <br />
            <asp:Button ID="Button1" runat="server" Text="Şifre Değiştir" CssClass="btn btn-success" Width="700" Style="font-size: 16px;" />
            <br />
            <style type="text/css">
