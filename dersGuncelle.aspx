<%@ Page Title="" Language="C#" MasterPageFile="~/ogretmen.Master" AutoEventWireup="true" CodeBehind="dersGuncelle.aspx.cs" Inherits="ogrenciYonetim.dersGuncelle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            <form runat="server">
    <div class="form-group">
        <h2 style="color: dimgray">Ders Güncelleme</h2>
        <br />
       ...
       <br />
        <asp:Button ID="btnKaydet" runat="server" Text="Ders Güncelle" CssClass="btn btn-success" OnClick="btnKaydet_Click"    />
    </div>
</form>
</asp:Content>
